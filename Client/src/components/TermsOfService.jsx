      ...
      >
        ...
        >
          ...
          >
            ...
            <h3 style={{ textDecoration: "underline" }}>Agreements to terms</h3>
            <p>
              These Terms of Use constitute a legally binding agreement made
              between you, whether personally or on behalf of an entity (“you”)
              and Strats Inc (“Company”, “we”, “us”, or “our”), concerning your
              access to and use of the
              https://valorant-tracker-production.up.railway.app/ website as
            ...
            <h3 style={{ textDecoration: "underline" }}>User Registration</h3>
            <p>
            ...
            <ol>
              <li>
                ...
                compilation, database, a collection, compilation, database, or
            ...
            <h3 style={{ textDecoration: "underline" }}>Submissions</h3>
            <p>
            ...
            <h3 style={{ textDecoration: "underline" }}>Advertisers</h3>
            <p>
            ...
            <h3 style={{ textDecoration: "underline" }}>Site Management</h3>
            <p>
            ...
            <h3 style={{ textDecoration: "underline" }}>Privacy Policy</h3>
            <p>
              ...
              advised the Site is hosted in Canada. If you access the Site from
              ...
              from applicable laws in Canada, then through your continued use of
              the Site, you are transferring your data to Canada, and you agree
            ...
            <h3 style={{ textDecoration: "underline" }}>Governing Law</h3>
            <p>
              These terms shall be governed by and defined following the laws of
              Canada. Strats Inc and yourself irrevocably consent that the
              courts of Canada shall have exclusive jurisdiction to resolve any
              dispute which may arise in connection with these terms.
            </p>
            <h3 style={{ textDecoration: "underline" }}>Dispute Resolution</h3>
            <p>
              ...
              of the Canada courts. Strats Inc shall also maintain the right to
            ...
            <h3 style={{ textDecoration: "underline" }}>Corrections</h3>
            <p>
            ...
            <h3 style={{ textDecoration: "underline" }}>Indemnification</h3>
            <p>
            ...
            <h3 style={{ textDecoration: "underline" }}>User Data</h3>
            <p>
            ...
            <h3 style={{ textDecoration: "underline" }}>Miscellaneous</h3>
            <p>
            ...
            <a href="mailto:rcalderon0907@gmail.com">
              <p>rcalderon0907@gmail.com</p>
            </a>
          </div>
        </div>
      </div>
